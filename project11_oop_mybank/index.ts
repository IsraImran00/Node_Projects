...
const customers: Customer[] = [
    new Customer("Isra", "Imran", 23, "Female", 3002121212, accounts[0]),
    new Customer("Saima", "Imran", 42, "Female", 3003131313, accounts[1]),
    new Customer("Ali", "Imran", 21, "Male", 3004141414, accounts[2])
